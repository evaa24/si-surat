...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h6 mb-0 text-gray-800">Data Surat Masuk Sekretaris</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item">Surat Masuk Sekretaris</li>
        <li class="breadcrumb-item active" aria-current="page">Data Surat Masuk Sekretaris</li>
    </ol>
</div>
