...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h6 mb-0 text-gray-800">Data Surat Keluar Kepala</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item">Surat Keluar Kepala</li>
        <li class="breadcrumb-item active" aria-current="page">Data Surat Keluar Kepala</li>
    </ol>
</div>
