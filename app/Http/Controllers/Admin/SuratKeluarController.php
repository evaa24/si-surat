...
class SuratKeluarController extends Controller
{
    ...
    {
        // $listSurat = $this->suratKeluarService->getListSuratDisposisi()->getData('data')['data']['list_disposisi'];
        ...
        return view('dashboard.admin.surat-keluar.disposisi', [
    ...
    public function getListArsip()
    {
        ...
        return view('dashboard.admin.surat-keluar.arsip', [
    ...
    public function getListSurat()
    {
        ...
        $listSurat = $this->suratKeluarService->getListSurat()->getData('data')['data'];
        ...
        $listStaff = $this->suratKeluarService->getListStaffUntukDisposisi()->getData('data')['data']['list_staff'];
        ...
        return view('dashboard.admin.surat-keluar.list', [
            'title' => 'Data Surat Keluar',
            'data' => [
                'list_surat' => $listSurat['list_surat_keluar'],
    ...
    public function addSurat(Request $request)
    {
        ...
        $orderedData = [
            ...
            "disposisi_user_id" => $data['disposisi_user_id'],
        ];
